...
import { ArrowLeft, Search, SortAsc, SortDesc, MapPin, Calendar, ZoomIn, X, Target, TrendingUp, AlertTriangle, Filter, ExternalLink, Upload } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="p-6 lg:p-8">
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <CardContent>
              {!showResults ? (
                ...
                <div className="text-center py-4">
                  <p className="text-gray-600">PDF analysis completed. Click "Analyze New PDF" to upload another file.</p>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          {/* Show mock data only if no real analysis results */}
          {!showResults && (
            <>
