...
| Helipad | Helipad | 0.19% |`;
  ...
  const compatibilityBoxes = [
    { text: "Mountain road construction experience", shade: "green" },
    { text: "High altitude project capability", shade: "green" },
    { text: "Advanced drainage systems", shade: "green" },
    { text: "Remote logistics management", shade: "red" },
    { text: "EPC contract expertise", shade: "green" },
    { text: "Government tender portfolio", shade: "green" },
    { text: "Specialized equipment access", shade: "red" },
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-center">
                ...
                <div className="flex justify-center flex-1">
                  <div className="grid grid-cols-3 gap-6 max-w-lg w-full">
                    {/* Top row */}
                    <div className={`aspect-square rounded-xl p-4 flex items-center justify-center text-center transition-all duration-300 hover:shadow-md border-2 ${
                ...
                <div className="flex-1 space-y-6">
                  <div className="bg-gradient-to-br from-teal-50 to-blue-50 rounded-xl p-6 border border-teal-200">
                    <h3 className="text-lg font-semibold text-teal-700 mb-4">Analysis Summary</h3>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-3 bg-white/60 rounded-lg">
                        <span className="text-sm font-medium text-gray-700">Strengths</span>
                        <span className="text-sm font-bold text-green-600">
                          {compatibilityBoxes.filter(box => box.shade === 'green').length}/8
                        </span>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-white/60 rounded-lg">
                        <span className="text-sm font-medium text-gray-700">Areas for Improvement</span>
                        <span className="text-sm font-bold text-red-600">
                          {compatibilityBoxes.filter(box => box.shade === 'red').length}/8
                        </span>
                      </div>
                      <div className="p-4 bg-white/80 rounded-lg border-l-4 border-teal-400">
                        <p className="text-sm text-gray-700 leading-relaxed">
                          <span className="font-semibold">Recommendation:</span> This tender shows good alignment with your core competencies. 
                          Focus on strengthening logistics partnerships and equipment access for mountain construction projects.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-green-50 rounded-xl p-4 border border-green-200">
                      <h4 className="font-semibold text-green-700 text-sm mb-2">Key Strengths</h4>
                      <ul className="text-xs text-green-600 space-y-1">
                        <li>• Proven EPC experience</li>
                        <li>• Mountain road expertise</li>
                        <li>• Government tender track record</li>
                      </ul>
                    </div>
                    <div className="bg-red-50 rounded-xl p-4 border border-red-200">
                      <h4 className="font-semibold text-red-700 text-sm mb-2">Focus Areas</h4>
                      <ul className="text-xs text-red-600 space-y-1">
                        <li>• Remote site logistics</li>
