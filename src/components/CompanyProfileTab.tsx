...
const CompanyProfileTab: React.FC = () => {
  ...
  const [companyData, setCompanyData] = useState({
    name: profile?.companyName || "Rajesh Kumar",
    contactPerson: user?.name || "rajeshkumar@gmail.com",
    ...
    description:
      "Leading infrastructure development company with 15+ years of experience in road construction and bridge development projects across North India.",
  });
  ...
  const handleSaveProfile = () => {
    if (!editData) {
      toast({
        ...
        description: "Edit data to proceed with saving.",
        variant: "destructive",
      });
      return;
    }
          ...
          <Card className="rounded-xl border-0 shadow-lg mb-6">
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                <CompatibilityScore
                  score={stats.avgCompatibilityScore}
                  showTooltip={false}
                />
